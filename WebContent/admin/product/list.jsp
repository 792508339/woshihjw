...
<script type="text/javascript">
			function addProduct(){
				window.location.href = "${pageContext.request.contextPath}/categoryWeb";
			}
			
			function delet(pid){
				var dele = confirm("确定是否删除");
				if(dele){
					location.href="${pageContext.request.contextPath}/deletProduction?pid="+pid;
				}
			}
			$(function(){
				...
				<tr>
					<td class="ta_01" align="center" bgColor="#f5fafe">
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<c:forEach items="${product }" var="pro" varStatus="vs">
							...
							<tr onmouseover="this.style.backgroundColor = 'white'"
								...
								<td align="center" style="HEIGHT: 22px"><a
									href="${ pageContext.request.contextPath }/showServlet?pid=${pro.pid}">
										<img
										src="${pageContext.request.contextPath}/images/i_edit.gif"
										border="0" style="CURSOR: hand">
								</a></td>
								<td align="center" style="HEIGHT: 22px">
								<a href="javascript:void(0);" onclick="delet('${pro.pid }')"> 
								<img
